...
seek($8000); Start:
  ...
  LoadPAL(Coins_pal, $00, Coins_pal.end - Coins_pal, 0)
  LoadVRAM(Coins_chr, $0000, Coins_chr.end - Coins_chr, 0) // Load 1BPP Tiles To VRAM Lo Bytes (Converts To 2BPP Tiles)
  LoadPAL(Explosions_pal, $0F, Explosions_pal.end - Explosions_pal, 0)
  LoadVRAM(Explosions_chr, $1200, Explosions_chr.end - Explosions_chr, 0) // Load 1BPP Tiles To VRAM Lo Bytes (Converts To 2BPP Tiles)
...
//BGPAL:
//  dw $0000, $0F00 // Black / White Palette (4 Bytes)
//BGCLEAR:
